...
namespace ArenaGame.Heroes
{
	...
	{
		public Assassin(string name, double armor, double strength, IWeapon weapon, IPet pet, IWriter writer, ShopController shopController)
		...
		public override void LevelUp()
		{
			...
			Strength += GameConstants.AttackBoostPerLevel + 3;
		}
	}
}
